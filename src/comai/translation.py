...
def translate_to_command(nl_description, openai_api_key, prev_messages, context: context.Context): 
    ...
    system = f'You are a bot translating natural language instructions into commands for {context.shell} in {context.system}. Your output is just an executable command'
